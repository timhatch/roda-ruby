...
--
-- Name: Params; Type: TABLE; Schema: public; Owner: timhatch
--
...
ALTER TABLE public."Params" OWNER TO timhatch;

--
-- Name: Session; Type: TABLE; Schema: public; Owner: timhatch
--
...
ALTER TABLE public."Session" OWNER TO timhatch;

--
-- Name: climbers; Type: TABLE; Schema: public; Owner: timhatch
--
...
ALTER TABLE public.climbers OWNER TO timhatch;

--
-- Name: competitions; Type: TABLE; Schema: public; Owner: timhatch
--
...
ALTER TABLE public.competitions OWNER TO timhatch;

--
-- Name: results; Type: TABLE; Schema: public; Owner: timhatch
--
...
CREATE TABLE public.results (
    ...
    sort_values integer[] DEFAULT '{}'::integer[],
    tie_breaks integer[],
...
ALTER TABLE public.results OWNER TO timhatch;

--
-- Data for Name: Params; Type: TABLE DATA; Schema: public; Owner: timhatch
--

COPY public."Params" (grp_id, discipline, gender, min_age, max_age, age_group) FROM stdin;
2	L	F	16	99	O15
5	B	F	16	99	O15
24	S	F	16	99	O15
42	C	F	16	99	O15
...
COPY public."Session" (wet_id, auth) FROM stdin;
1	\N
\.
...
COPY public.climbers (per_id, lastname, firstname, club, nation, birthyear, gender) FROM stdin;
...
COPY public.competitions (wet_id, city, date, title, routes, cats) FROM stdin;
...
COPY public.results (wet_id, grp_id, per_id, route, start_order, bib_nr, rank_prev_heat, sort_values, tie_breaks, result_jsonb, locked, rank_this_heat) FROM stdin;
...
1	5	61909	2	5	\N	2	\N	{0,0,1,4,0,1,2,3}	{"p1": {"a": 5, "b": 4}, "p2": {"a": 2, "b": 1, "t": 3}, "p3": {"a": 13, "b": 0, "t": null}, "p4": {"a": 2, "b": 2, "t": 2}}	f	\N
...
1	5	50691	2	6	\N	4	\N	{0,0,2,2,0,1,2,4}	{"p1": {"a": 5, "b": 4}, "p2": {"a": 2, "b": 1, "t": 3}, "p3": {"a": 13, "b": 0, "t": null}, "p4": {"a": 2, "b": 1, "t": 2}}	f	\N
1	5	61905	2	4	\N	3	\N	{0,0,0,1,0,0,1,4}	{"p1": {"a": 1, "b": 0, "t": null}, "p2": {"a": 1, "b": 0, "t": null}, "p3": {"a": 4, "b": 4, "t": 0}, "p4": {"a": 1, "b": 1, "t": 1}}	f	\N
1	6	5090	2	\N	\N	\N	{}	\N	\N	f	\N
1	5	1030	2	1	4	4	\N	{0,0,1,3,0,1,2,4}	{"p1": {"a": 5, "b": 4}, "p2": {"a": 2, "b": 1, "t": 3}, "p3": {"a": 13, "b": 0, "t": null}, "p4": {"a": 1, "b": 1, "t": 1}}	f	\N
1	5	5089	2	7	\N	7	\N	\N	{}	f	\N
1	5	5090	2	\N	\N	\N	\N	\N	{"p1": {"a": 5, "b": 4}, "p2": {"a": 2, "b": 1, "t": 3}, "p3": {"a": 13, "b": 0, "t": null}, "p4": {"a": 1, "b": 1, "t": 1}}	f	\N
1	5	6064	2	3	\N	4	\N	{0,0,2,2,0,1,2,4}	{"p1": {"a": 5, "b": 4}, "p2": {"a": 2, "b": 1, "t": 3}, "p3": {"a": 13, "b": 0, "t": null}, "p4": {"a": 1, "b": 1, "t": 1}}	f	\N
1	5	12027	2	2	\N	5	\N	{0,0,0,4,0,3,3,5}	{"p1": {"a": 2, "b": 3, "t": 0}, "p2": {"a": 5, "b": 5, "t": 0}, "p3": {"a": 5, "b": 3, "t": 4}, "p4": {"a": 1, "b": null, "t": null}}	f	\N
\.


--
-- Name: climbers Climbers_pkey; Type: CONSTRAINT; Schema: public; Owner: timhatch
--
...
--
-- Name: competitions Competitions_pkey; Type: CONSTRAINT; Schema: public; Owner: timhatch
--
...
--
-- Name: results Results_pkey; Type: CONSTRAINT; Schema: public; Owner: timhatch
--
...
--
-- Name: Params params_pkey; Type: CONSTRAINT; Schema: public; Owner: timhatch
--
